...
def make_ld_probe_buttons(tk, root):
    ...
    ld_probe_button_last_day_all.grid(row=0, column=4)

    ld_probe_enter_day = tk.Entry(root, width=10)
    ld_probe_enter_day.grid(row=1, column=5)
    ...
    ld_probe_button_select_day.grid(row=1, column=4)

    ld_probe_enter_id = tk.Entry(root, width=10)
    ld_probe_enter_id.grid(row=2, column=5)
    ...
    ld_probe_button_select_id.grid(row=2, column=4)

    ld_probe_block_number = tk.Entry(root, width=10)
    ld_probe_block_number.grid(row=3, column=5)
    ...
    ld_probe_button_select_block.grid(row=3, column=4)

    ld_probe_button_last_day_avg = tk.Button(root, text='LD Probe (Last Day All Avg)', command=ld_probe_last_day_avg,
                                             width=30)
    ld_probe_button_last_day_avg.grid(row=4, column=4)

    ld_probe_button_block_avg_text = tk.Entry(root, width=10)
    ld_probe_button_block_avg_text.grid(row=5, column=5)
    ...
    ld_probe_button_block_avg = tk.Button(root, text='LD Probe (Block Avg)',
                                          ...
                                          width=30)
    ld_probe_button_block_avg.grid(row=5, column=4)

    ld_probe_button_id_avg_text = tk.Entry(root, width=10)
    ld_probe_button_id_avg_text.grid(row=6, column=5)
    ...
    ld_probe_button_id_avg.grid(row=6, column=4)